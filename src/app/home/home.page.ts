...
export class HomePage implements OnInit {
    ...
    public registerSubscribeData() {
        console.log('7777 registerSubscribeData');
        this.bluetoothSerial.subscribeRawData().subscribe((data) => {
            console.log('2registerSubscribeData data', data);
            this.bluetoothSerial.read().then((data) => {
                ...
                this.parseTags(data);
                console.log('3 registerSubscribeData data', data);
    ...
    public clearRequester() {
        console.log('clearRequester')
        this.requester = '';
    }

    public clearDevices() {
        console.log('clearDevices')
        this.devices = [];
    }
    ...
    public checkBluetothIsEnabled() {
        console.log('checkBluetothIsEnabled')
    ...
    public getInventory() {
        ...
        this.bluetoothSerial.write(R900Protocol.CMD_INVENT).then(
            data => {
                ...
                this.openInterface('stop', (data) => { 
                    console.log('66 openInterface', data)
                });
            },
            err => {
                console.log('err', err);
    ...
    public isIncluded(element, cb) {
        console.log('isIncluded', element);
        let included = false;
